...
# definition of the print function
show.apirequest <- function(object) {
...
summary.apiresp <-
  function(object){
    ...
    s <- new(Class="sapiresp", summary=list(levelsummaries, levelnames), raw.type=object@type, statusMessage=object@statusMessage)
...
# definition of the print function
print.summary.apiresp <- function(x) {
...
# definition of the print function
show.summary.apiresp <- function(object) {
...
# method definition
plot.apiresp <-
  function(x, type="normal", char.lim=8, all=FALSE, leveldist=0.15, vertex.size=16, vertex.shape="none", vertex.label.cex=0.7, ...) 
  {
...
summary.apidata <-
  function(object){
    ...
    s <- new(Class="sapidata", summary=totalsummary, varsummary=s.list)
...
# definition of the print function
print.summary.apidata <- function(x) {
...
# definition of the print function
show.summary.apidata <- function(object) {
