...
##' @param backupfile character string with the path/name of the backup-file where the data should be saved batchwise during the download process.
##' @param unify logical, indicating whether the resulting tables (data frames) should be unified (default is TRUE, see unifyDataframes())
...
##' @param progress, either character "bar" (indicates progress with a progress-bar), "text" (textual indication of progress)
...
##' @details The core of the function is based on mapiDatalight(). However, it is specifically designed for the processing of various requests and a save download of the data.
