...
##' 
##'  A function that transforms n tree structured data sets (represented as a nested list) to a list
##'   of n R-data frames. (vectorized verion of tree2flat)
##' @usage mtree2flat(x, ids)
##' @param x a list with nested lists, each representing tree structured data from an API response 
##' (originally JSON or XML).
##' @param ids a character vector with id-variables to separate individual observations in the 
##' entities of x. each character string is the id of the respective list entry in x 
##' (i.e. ids[1] is the id of x[[1]]).
